...
function srizon_mortgage_load_site_head_resources() {
	...
	wp_enqueue_style( 'srizon-instagram-site', srizon_mortgage_get_resource_url( 'site/resources/app.css' ), null, '1.0' );
}
...
function srizon_mortgage_load_site_footer_resources() {
	...
	wp_enqueue_script( 'srizon-instagram-site', srizon_mortgage_get_resource_url( 'site/resources/app.js' ), [ 'jquery' ], '1.0', true );
}
