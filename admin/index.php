...
function srizon_mortgage_load_admin_resources() {
	...
	wp_enqueue_style( 'srizon-instagram-admin', srizon_mortgage_get_resource_url( 'admin/resources/app.css' ), null, '1.0' );
	...
	wp_enqueue_script( 'srizon-instagram-admin', srizon_mortgage_get_resource_url( 'admin/resources/app.js' ), null, '1.0', true );
}
